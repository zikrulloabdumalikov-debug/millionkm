        ...
        <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-xl border border-[#E5E5EA] text-center">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-10 max-w-3xl mx-auto">
              ...
              <div>
                 ...
                 <input type="number" placeholder="2023" value={year} onChange={e => setYear(e.target.value)} className="apple-input h-[50px]" />
              </div>
              <div>
                 <label className="text-[12px] font-semibold text-[#86868B] mb-1.5 block ml-1">Probeg (KM)</label>
                 <input type="text" placeholder="35 000" value={km} onChange={e => setKm(e.target.value)} className="apple-input h-[50px]" />
              </div>
           </div>
  ...
  return (
    <div id="brands" className="py-24 bg-white border-t border-gray-100">
      <div className="max-w-[1080px] mx-auto px-6">
        ...
        {selectedModel && (
           <div className="mt-12 animate-fade-up">
              <div className="p-8 md:p-12 bg-[#F5F5F7] rounded-[32px] border border-gray-200 text-center">
