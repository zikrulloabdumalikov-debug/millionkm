...
import NearestLocations from './components/NearestLocations.jsx';
...
const App = () => {
  ...
  const handleLoginSubmit = () => {
    if (loginForm.name.toLowerCase() === 'admin' && loginForm.password === '123') {
      const adminUser = { uid: 'a1', name: 'Admin', isAdmin: true };
    ...
    const user = { uid: 'u-' + Date.now(), name: loginForm.name, phone: loginForm.phone, isAdmin: false };
    setCurrentUser(user);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="py-20 bg-white border-t border-gray-100 mt-auto">
